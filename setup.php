...
echo "--------------------------------------------------------\n";
echo "WELCOME TO THE HAAS INSTALLER! \n";
echo "--------------------------------------------------------\n\n";
...
if (version_compare(PHP_VERSION, $required_version, '<')) {
    echo "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! ERROR !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n";
    echo "This version of PHP (".PHP_VERSION.") is not compatible with HAAS.\n";
    echo "HAAS requires PHP version ".$required_version." or greater. Please upgrade \n";
